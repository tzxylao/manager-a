...
import com.tzxylao.manager.entity.Tuser;
import com.tzxylao.manager.entity.Tuserrole;
import com.tzxylao.manager.model.JqgridBean;
import com.tzxylao.manager.model.PageRusult;
import com.tzxylao.manager.service.TroleService;
import com.tzxylao.manager.service.TuserService;
import com.tzxylao.manager.service.TuserroleService;
    ...
    public Map<String, Object> addupdateuser(Tuser tuser) {
        ...
        try {
            if (tuser.getId() == null) {//新建
                ...
                tuser.setPassword(new Sha256Hash(tuser.getPassword()).toHex());
                List<Tuser> userlist = userService.selectByExample(tuserExample);
