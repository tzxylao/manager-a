package com.tzxylao.manager.config;

import com.tzxylao.manager.realm.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/test/ip", "anon");
        filterChainDefinitionMap.put("/test/ip2", "anon");
